...
class SamAutomaticMaskGenerator:
    def __init__(
        self,
        model: Sam,
        points_per_side: Optional[int] = 50,
    ...
    @torch.no_grad()
    def generate(self, image: np.ndarray,ref_infor, SLIC_centers, super_pixel) -> List[Dict[str, Any]]:
        """
        ...
        # Generate masks
        mask_data, mask_size = self._generate_masks(image,ref_infor, SLIC_centers, super_pixel)
    ...
    def _generate_masks(self, image: np.ndarray,ref_infor, SLIC_centers, super_pixel) -> MaskData:
        ...
        if super_pixel:
          ...
          # points_per_side = (self.points_per_side//(1.2*mask_size)+1)*self.points_per_side
          self.point_grids = build_point_grid(int(self.points_per_side))
